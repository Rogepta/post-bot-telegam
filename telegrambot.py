...
async def generate_summary(article: Article) -> Optional[str]:
    ...
    if fmt == "short":
        instruction = "Кратко: 1–2 предложения, только суть. Длина: 60–150 символов."
    elif fmt == "medium":
        instruction = "Кратко: 2–4 предложения. Длина: 150–350 символов."
    else:
        instruction = "Развёрнуто: 3–5 предложений, можно добавить контекст и предысторию. Длина: 350–600 символов."

    prompt = f"""Ты — редактор Telegram-канала про киберспорт и видеоигры. Перепиши новость строго по фактам из статьи, ничего не додумывая.
